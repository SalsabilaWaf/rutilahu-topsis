            ...
            <div class="collapse show" id="collapseCardExample">
                <div class="card-body">
                    <p class="mb-0 text-dark">
                        ...
                        didalam Sistem Pendukung Keputusan Penerima Dana Bantuan Rumah Tidak Layak Huni (RTLH) Desa Klepu
                    <p class="text-dark"> Kecamatan Pringsurat Kabupaten Temanggung Jawa Tengah.
                    </p>
...
<?php if ($this->session->userdata('id_user_level') == '2') : ?>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <p class="mb-0 text-dark">
                Selamat Datang <span class="text"><b><?= $this->session->username; ?></b></span>
                didalam Sistem Pendukung Keputusan Penerima Dana Bantuan Rumah Desa Klepu
            <p class="text-dark"> Kecamatan Pringsurat Kabupaten Temanggung.
            </p>
