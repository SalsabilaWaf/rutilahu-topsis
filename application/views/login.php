...
<html lang="en">
    <head>
        ...
        <title>Login | Sistem Pendukung Keputusan RTLH Desa Klepu</title>
		...
		<link rel="icon" href="<?= base_url('assets/img/profile/logo.png')?>" type="image">
    </head>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        <img src="<?= base_url('assets/img/profile/logo.png')?>" alt="" width="30%" style="margin-bottom: 15px;">
                                            
                                            <h5 class="pt-0 mt-1 mb-4 text-white">
                                                Sistem Pendukung Keputusan Penerima Dana Bantuan Rumah Tidak Layak Huni (RTLH) Desa Klepu Kecamatan Pringsurat
                                            </h5>
