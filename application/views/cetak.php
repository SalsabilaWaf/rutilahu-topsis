...
<html>
<head>
	<title>Sistem Pendukung Keputusan RTLH Desa Klepu</title>
</head>
<style>
    table {
...
<body>
	...
	<img src="<?= base_url('assets/img/profile/logo.png')?>" alt="Logo Rutilahu Desa Klepu" style="position: absolute; width: 65px; height: 75px;">
	...
	<tr>
        ...
        <b>KECAMATAN PRINGSURAT</b>
		<h2 class="line-title1">DESA KELPU</h2>
        Jl. Pingit-Sumowono Km 3 Ngepoh, Pringsurat, Temanggung 
     <hr  class="hr-border">
		</td>
	</tr>
</table>
...
<table class="ttd" style="width: 100%;">
    <thead>
        <tr align="center">
            ...
            <td>
              Klepu, <?php date_default_timezone_set("Asia/Jakarta"); echo date("d, M Y")?><br>
                <p class="kades">Kepala Desa Klepu,</p><br><br>
                <b class="nama-kades">Endro Pramito
                </br>
